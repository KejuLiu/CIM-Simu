//这段 JavaScript 代码
// 实现了改进的柏林噪声（Improved Perlin Noise），
// 一种渐变噪声，通常用于计算机图形学中生成自然LOOK的纹理、地形以及其他现象。
const _p = [ 151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103, 30, 69, 142, 8, 99, 37, 240, 21, 10,
	 ...
	 //随机排列数组，是0到255的随机整数，用于创建伪随机的梯度向量
//过程
for ( let i = 0; i < 256; i ++ ) {
...
function fade( t ) {//淡化函数

	return t * t * t * ( t * ( t * 6 - 15 ) + 10 );

}

function lerp( t, a, b ) {//线性插值

	return a + t * ( b - a );

}

function grad( hash, x, y, z ) {//梯度函数
...
class ImprovedNoise {
//noise 方法接收三个坐标 (x, y, z)，并计算该点的柏林噪声值。
	noise( x, y, z ) {
