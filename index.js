...
// 修改 dat.GUI 的样式，避免和菜单冲突
var guiContainer = gui.domElement;
guiContainer.style.position = 'absolute'; // 确保固定位置
guiContainer.style.top = '60px'; // 菜单高度 + 间距
guiContainer.style.right = '10px'; // 靠右侧边距
guiContainer.style.zIndex = '1000'; // 保证在前面显示
